...
def models(embeddings,data_max_shapes,hidden_size,embedding_dim):
    ...
    context_decoder_lstm = LSTM(hidden_size,return_state=True)
    ...
    question_decoder_lstm = LSTM(hidden_size,return_state=True)
    ...
    decoder_dense = Dense(len_answer_vocab, activation='softmax')
