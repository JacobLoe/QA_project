...
################################################################
path = 'models/baseline_attention_100'
# rnn parameters
context_hidden_size = 100 #100 is the standard
question_hidden_size = 100 #100 is the standard
BATCH_SIZE = 128 #for the training on the GPU this to be has to very large, otherwise the GPU is used very inefficiently
EPOCHS = 200
